console.log('BabyFood base estable PC cargada v18');
'use strict';
const STORAGE_KEY='bf_base_estable_pc_v18';
const OLD_KEYS=['bf_base_estable_pc_v17','bf_base_estable_pc_v16','bf_base_estable_pc_v15','bf_base_estable_pc_v14','bf_base_estable_pc_v12','bf_base_estable_pc_v11','bf_base_estable_pc_v10'];
const CAT_ICON={verdura:'🥦',cereal:'🌾',proteina:'🍗',fruta:'🍎'};
const CAT_LABEL={verdura:'Verduras, hortalizas y tubérculos',cereal:'Cereales y bases',proteina:'Proteínas',fruta:'Frutas'};
