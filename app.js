console.log('BabyFood editable v19 cargada');
'use strict';
...
let S=deepClone(INITIAL_STATE); let calViewDate=new Date(); let lastReportText=''; let BLOCK_SWAP=null; let DAY_SWAP=null; let DAY_ADD=null; let GENERATION_JITTER=0;
